...
//             setDate(d);
//           }}
//           className="rounded-md border transform scale-90 sm:scale-100 origin-top"
//           modifiers={{ highlighted: eventDates }}
//           modifiersClassNames={{
//             highlighted: "bg-emerald-400 text-white font-bold rounded-full",
//           }}
...
//               <div
//                 key={event?._id}
//                 className="border p-4 rounded-lg shadow-md bg-white/90 backdrop-blur-sm flex flex-col justify-between text-sm"
//               >
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
        ...
        <Calendar
          ...
          className="rounded-md border transform scale-95 origin-top"
          modifiers={{ highlighted: eventDates }}
          modifiersClassNames={{
            highlighted: "bg-emerald-400 text-white font-bold rounded-full",
          }}
